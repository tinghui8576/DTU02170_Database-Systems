...
# 2.13 Get all data in the Student table
SELECT * FROM Student; 
# 2.14 Get all data in the Course table
SELECT * FROM Course;
# 2.15 Get the name of all students
SELECT StudName FROM Student;
# 2.16 Get the name and total credits of all students
SELECT StudName, TotCredits FROM Student;
# 2.17 Get the name, salary and department of all instructors.
SELECT InstName, Salary, DeptName FROM Instructor;
# 2.18 Get the names of all students with a total credit of more than 100.
SELECT StudName FROM Student Where TotCredits>100;
# 2.19 Get the students in Computer Science with a total credit of more than 100.
SELECT StudName FROM Student Where DeptName = "Comp. Sci." AND TotCredits>100;
# 2.20 Get the rooms with a capacity between 25 and 50, or located in the Painter building.
SELECT * FROM Classroom Where (Capacity >= 25 AND Capacity<=50) OR Building = "Painter";
# 2.21 Get all department names not located in the Taylor building.
SELECT DeptName FROM Department Where Building!= "Taylor";
# 2.22 What are the Course ID, year and grade for all courses taken by student Shankar?
SELECT CourseID, StudyYear, Grade FROM Takes NATURAL JOIN Student Where StudName = "Shankar";
# 2.23 Create two new Comp. Sci. courses CS-102 and CS-103 in table Course titled Weekly Seminar and Monthly Seminar, both with 0 credits.
INSERT Course VALUES 
('CS-102','Weekly Seminar','Comp. Sci. ','0'),
('CS-103','Intro. to Biology','Comp. Sci. ','0');
# 2.24 Create a section for both CS-102 and CS-103 in Fall 2009, both with SectionID 1
INSERT Section VALUES
